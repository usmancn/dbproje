...
def get_data_count():
    ...
    try:
        ...
        # ecommerce.addresses tablosundan kayıt sayısını al
        cursor.execute("SELECT COUNT(*) FROM ecommerce.addresses")
...
try:
    ...
    print(f" ecommerce.addresses tablosunda şuan {initial_count:,} kayıt var")
